                        ...
                        <form action="{{ route('cart.update', $cart->cart_id) }}" method="POST"
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="number"
                                                    ...
                                                    name="panjang" id="panjang" value="{{ $cart->panjang }}"
                                        ...
                                        <div class="form-group" id="form-lebar">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="number"
                                                    ...
                                                    name="lebar" id="lebar" value="{{ $cart->lebar }}"
                                                    onchange="setLuas()" required min="1">
                                                <div class="input-group-append">
                                                    <span
                                                        class="input-group-text">{{ $product->category->satuan }}</span>
                                        ...
                                        <div class="form-group" id="form-luas">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="number"
                                                    ...
                                                    name="luas" id="luas" readonly value="{{ $cart->luas }}">
                                                <div class="input-group-append">
                                                    <span
                                                        class="input-group-text">{{ $product->category->satuan }}</span>
                                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control"
                                    name="price" id="price" value="{{  $cart->price }}" required
                                    readonly>
                                <input type="hidden" class="form-control"
                                    ...
                                    <select name="finishing_id" id="finishings" class="form-control"
                                        ...
                                        @foreach ($finishings as $finishing)
                                            <option value="{{ $finishing->finishing_id }}"
                                                data-price="{{ $finishing->finishing_price }}" {{$cart->finishing_id == $finishing->finishing_id ? 'selected' : ''}}>
                                                {{ $finishing->finishing }}
                            ...
                            @if (count($cuttings) != 0)
                                <div class="form-group">
                                    ...
                                    <select name="cutting_id" id="cuttings" class="form-control"
                                        onchange="setLuas()">
                                        <option value="">-- pilih cutting --</option>
                                        @foreach ($cuttings as $cutting)
                                            <option value="{{ $cutting->cutting_id }}" {{$cart->cutting_id == $cutting->cutting_id ? 'selected' : ''}}
                                                data-price="{{ $cutting->cutting_price }}">{{ $cutting->cutting }} -
                                                Rp.

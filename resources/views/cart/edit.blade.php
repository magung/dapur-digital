...
<head>
    ...
    <title>Edit Produk Keranjang</title>
     <!-- Bootstrap CSS -->
                        ...
                        <form action="{{$user->role_id == 4 ? route('cart.list.update', $cart->cart_id) : route('cart.update', $cart->cart_id)  }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control @error('price') is-invalid @enderror"
                                    name="price" id="price" value="{{ old('price', $cart->price) }}" required readonly>
                                <input type="text" class="form-control @error('price') is-invalid @enderror" id="price_show" value="{{ old('price',  number_format($cart->price)) }}" required readonly>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('satuan') is-invalid @enderror"
                                    name="satuan" id="satuan" value="{{ old('satuan', $cart->satuan) }}" required readonly>
                            ...
                            <div class="form-group" id="form-panjang">
                                ...
                                <input type="number" class="form-control @error('panjang') is-invalid @enderror"
                                    name="panjang" id="panjang" value="{{ old('panjang', $cart->panjang) }}" onchange="setLuas()" required>
                            ...
                            <div class="form-group" id="form-lebar">
                                ...
                                <input type="number" class="form-control @error('lebar') is-invalid @enderror"
                                    name="lebar" id="lebar" value="{{ old('lebar', $cart->lebar) }}" onchange="setLuas()" required>
                            ...
                            <div class="form-group" >
                                ...
                                <input type="number" class="form-control @error('qty') is-invalid @enderror"
                                    name="qty" id="qty" value="{{ old('qty', $cart->qty) }}" onchange="setQty()" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" name="finishing_price" id="finishing_price" value="{{ old('finishing_price', $cart->finishing_price) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" name="cutting_price" id="cutting_price" value="{{ old('cutting_price', $cart->cutting_price) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control @error('total_price') is-invalid @enderror"
                                    name="total_price" id="total_price" value="{{ old('total_price', $cart->total_price) }}" required readonly>
                                <input type="text" class="form-control @error('total_price') is-invalid @enderror" id="total_price_show" value="{{ old('total_price', number_format($cart->total_price)) }}" required readonly>
                            ...
                            <a href="{{ $user->role_id == 4 ? route('cart.list') : route('transaction.create') }}" class="btn btn-md btn-secondary">back</a>

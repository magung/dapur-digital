        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="card border-0 shadow rounded">
                    <div class="card-body">
                        <form
                            action="{{ $user->role_id == 4 ? route('cart.list.update', $cart->cart_id) : route('cart.update', $cart->cart_id) }}"
                            method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control @error('price') is-invalid @enderror"
                                    name="price" id="price" value="{{ old('price', $cart->price) }}" required
                                    readonly>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('satuan') is-invalid @enderror"
                                    name="satuan" id="satuan" value="{{ old('satuan', $cart->satuan) }}" required
                                    readonly>
                            ...
                            <div class="form-group" id="form-panjang">
                                ...
                                <input type="number" class="form-control @error('panjang') is-invalid @enderror"
                                    name="panjang" id="panjang" value="{{ old('panjang', $cart->panjang) }}"
                            ...
                            <div class="form-group" id="form-lebar">
                                ...
                                <input type="number" class="form-control @error('lebar') is-invalid @enderror"
                                    name="lebar" id="lebar" value="{{ old('lebar', $cart->lebar) }}"
                                    onchange="setLuas()" required min="1">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('qty') is-invalid @enderror"
                                    name="qty" id="qty" value="{{ old('qty', $cart->qty) }}"
                                    onchange="setQty()" required min="1">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" name="finishing_price" id="finishing_price"
                                    value="{{ old('finishing_price', $cart->finishing_price) }}">
                                <select name="finishing_id" id="finishings" class="form-control" onchange="setLuas()">
                                    ...
                                    @foreach ($finishings as $finishing)
                                        <option value="{{ $finishing->finishing_id }}"
                                            ...
                                            {{ $cart->finishing_id == $finishing->finishing_id ? 'selected' : '' }}>
                                            {{ $finishing->finishing }} - Rp.
                                            {{ number_format($finishing->finishing_price) }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" name="cutting_price" id="cutting_price"
                                    value="{{ old('cutting_price', $cart->cutting_price) }}">
                                <select name="cutting_id" id="cuttings" class="form-control" onchange="setLuas()">
                                    ...
                                    @foreach ($cuttings as $cutting)
                                        <option value="{{ $cutting->cutting_id }}"
                                            data-price="{{ $cutting->cutting_price }}"
                                            {{ $cart->cutting_id == $cutting->cutting_id ? 'selected' : '' }}>
                                            {{ $cutting->cutting }} - Rp. {{ number_format($cutting->cutting_price) }}
                                        </option>
                                    @endforeach
                                </select>
                                <!-- error message untuk role -->
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control @error('total_price') is-invalid @enderror"
                                    ...
                                    value="{{ old('total_price', $cart->total_price) }}" required readonly>
                                <input type="text" class="form-control @error('total_price') is-invalid @enderror"
                                    id="total_price_show"
                                    value="{{ old('total_price', number_format($cart->total_price)) }}" required
                                    readonly>

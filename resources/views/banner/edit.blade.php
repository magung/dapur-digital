                    ...
                    <div class="card-body">
                        <form action="{{ route('banner.update', $banner->banner_id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <img src="{{ route('image', $banner->photo) }}" alt="" width="200">
                            </div>

                            <div class="form-group">
                                <label for="description">Deskripsi</label>
                                <input type="text" class="form-control @error('description') is-invalid @enderror"
                                    name="description" value="{{ old('description', $banner->description) }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('link') is-invalid @enderror"
                                    name="link" value="{{ old('link', $banner->link) }}" required>

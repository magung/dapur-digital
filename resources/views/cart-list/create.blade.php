            ...
            <div class="col-md-12">
                ...
                <div class="card border-0 shadow rounded">
                    <div class="card-body">
                        ...
                        <form action="{{ route('transaction.pelanggan.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf

                            <div class="">
                                <label for="">List Produk di Keranjang</label><br>
                                <a href="{{ route('product-list.index') }}" class="btn btn-md btn-success mb-3 ">+ Produk</a>

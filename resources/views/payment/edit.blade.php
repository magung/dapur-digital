                        ...
                        <form action="{{ route('payment.update', $payment->payment_id) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('payment_method') is-invalid @enderror"
                                    name="payment_method" value="{{ old('payment_method', $payment->payment_method) }}" required>

                                <!-- error message untuk payment_method -->
                            ...
                            <a href="{{ route('payment.index') }}" class="btn btn-md btn-secondary">Kembali</a>
                        </form>
                    </div>
                </div>
            </div>

        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card border-0 shadow rounded">
                    <div class="card-body">
                        <form action="{{ route('transaction.customer.update', $transaction->transaction_list_id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                                        ...
                                        @forelse ($transaction_product_lists as $product)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="{{ route('transaction.customer.product.edit', $product->product_id) }}" class="btn btn-sm btn-primary">EDIT</a>
                                                    <a href="{{route('transaction.customer
                                                    .product.destroy', $product->product_id) }}" class="btn btn-sm btn-danger">HAPUS</a>
                                                </td>
                                            </tr>
                                            @php
                                                $no++;
